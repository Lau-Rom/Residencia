...
<body>
	<div class="container">
		<div class="container-fluid text-center">
			...
			<br>
			<p>Agrupación: <strong><?php echo $semillero; ?></strong></p>
		</div>



		<form id="loginform" action="edita_integrante.php" method="post">
			<div class="row aling-items-center form-group">
				<div class="col-xs-12 col-sm-9 col-md-6 col-lg-3 text-left"> 
					<button type="button" class="btn btn-outline-dark" onclick="location.href='home_semillero.php'">Atrás</button>
						<label>Ingresa el <strong>Folio integrante</strong> a <strong>editar:</strong></label>
						<input  input type="text" required name="edit" class="form-control form-control-sm firts_letter"><br>
		...
		<div>
			<table class="table">
				<thead>
					<tr>
						<th scope="col">No</th>
						<th scope="col">Folio Integrante</th>
