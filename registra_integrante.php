...
$f_ingreso   = date("y/m/d", strtotime($_POST["f_ingreso"]));
...
$folio_semillero =$folio_semillero . $random;
...
$pusch = "INSERT INTO db_gral (folio_semillero, semillero, nombre, a_paterno, a_materno, genero, nacionalidad, curp_id, edad, email, tel, instrumento, f_ingreso, estatus, nombre_escuela, clave_escuela, dir_escuela, nivel_escuela, grado_escuela, email_escuela, tel_escuela, nombre_tutor, parentesco_tutor, dir_tutor, poblacion_tutor, municipio_tutor, cp_tutor, estado_tutor, tel_tutor, email_tutor, nombre_tutor1, tel_tutor1, parentesco_tutor1) VALUES ('$folio_semillero','$semillero','$nombre','$a_paterno','$a_materno','$genero','$nacionalidad','$curp_id','$edad','$email','$tel','$instrumento','$f_ingreso','$estatus','$nombre_escuela','$clave_escuela','$dir_escuela','$nivel_escuela','$grado_escuela','$email_escuela','$tel_escuela','$nombre_tutor','$parentesco_tutor','$dir_tutor','$poblacion_tutor','$municipio_tutor','$cp_tutor','$estado_tutor','$tel_tutor','$email_tutor','$nombre_tutor1','$tel_tutor1','$parentesco_tutor1')";
