	...
	<div class="container abc">
		...
		<div class="row aling-items-center">
			<div class="col-xs- 12 col-sm-9 col-md-6 col-lg-3 text-center">
				<button class="button1" onclick="location.href='agregar_agrupaciones.php'" >Agregar Agrupaciones</button>
			</div>
			<div class="col-xs- 12 col-sm-9 col-md-6 col-lg-3 text-center">
				<button class="button2" onclick="location.href='#'">Agregar Docentes</button>
			</div>
			<div class="col-xs- 12 col-sm-9 col-md-6 col-lg-3 text-center" >
				<button class="button3" onclick="location.href='#'">Otro</button>
			</div>
			<div class="col-xs- 12 col-sm-9 col-md-6 col-lg-3 text-center">
